...
public class CrmMember {
	...
	public String getMatchingMem_password() {
		return matchingMem_password;
	}

	public void setMatchingMem_password(String matchingMem_password) {
		this.matchingMem_password = matchingMem_password;
	}
